 ...
 * @delim: Delimiter string containing characters to match.
 * Return: 1 if all characters in str match those in delim, 0 otherwise.
 */
 ...
 * @delim: Delimiter string containing characters to use as delimiters.
