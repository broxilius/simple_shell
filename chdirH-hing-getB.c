...
/**
* cd_to - Handles 'cd' command to change to a.
*
* @datash: structure containing.
* Return: None.
*/
...
/**
* cd_previous - Handles 'cd -' command to the previous.
*
* @datash: structure containing shell info.
* Return: None.
*/
...
/**
* cd_to_home - the 'cd' to change to the user's directory.
* @datash: Data containing shell info.
* Return: None.
*/
